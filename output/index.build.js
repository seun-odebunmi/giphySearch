...
var _resultsList = __webpack_require__(69);
...
var ResultsListContainer = (0, _reactRedux.connect)(mapStateToProps)(_resultsList2.default);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ inputChange: _actions.inputChange, fetchGif: _actions.fetchGif }, dispatch);
};
...
var _resultsList = __webpack_require__(78);
...
var store = (0, _redux.createStore)((0, _redux.combineReducers)({
  resultsList: _resultsList2.default,
...
var ResultsList = function ResultsList(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      isRequesting && _react2.default.createElement(
        "p",
        null,
        _react2.default.createElement("i", { className: "fa fa-spinner fa-spin fa-4x" }),
        "Loading..."
      ),
      response && _react2.default.createElement(
        "div",
        { className: "animated bounceIn delay-4s" },
...
var _searchField = __webpack_require__(28);

var _searchField2 = _interopRequireDefault(_searchField);

var _resultsList = __webpack_require__(27);
...
var searchFieldReducer = function searchFieldReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  switch (action.type) {
    case _actionTypes.FETCH_GIF_REQUEST:
      return Object.assign({}, state, {
        isRequesting: true
      });
    case _actionTypes.FETCH_GIF_FAILURE:
      return Object.assign({}, state, {
        isRequesting: false,
        error: action.payload
      });
    case _actionTypes.FETCH_GIF_SUCCESS:
      return Object.assign({}, state, {
        isRequesting: false,
...
exports.default = searchFieldReducer;
...
exports.requestSuccess = exports.requestFailure = exports.requestGif = exports.inputChange = undefined;
exports.fetchGif = fetchGif;

var _actionTypes = __webpack_require__(81);

var API_KEY = 'deokzgUjxm6QHQdp3H3aca1LSZcCpucc';

var inputChange = exports.inputChange = function inputChange(inputValue) {
  return {
...
var requestGif = exports.requestGif = function requestGif() {
  return {
    type: _actionTypes.FETCH_GIF_REQUEST
  };
};

var requestFailure = exports.requestFailure = function requestFailure(error) {
  return {
    type: _actionTypes.FETCH_GIF_FAILURE,
    payload: error
  };
};

var requestSuccess = exports.requestSuccess = function requestSuccess(response) {
  return {
    type: _actionTypes.FETCH_GIF_SUCCESS,
    payload: response
  };
};

function fetchGif(item) {
  return function (dispatch) {
    dispatch(requestGif());
    return fetch('https://api.giphy.com/v1/gifs/search?api_key=' + API_KEY + '&q=' + item + '&limit=25&offset=0&rating=Y&lang=en').then(function (response) {
...
var FETCH_GIF_REQUEST = exports.FETCH_GIF_REQUEST = 'FETCH_GIF_REQUEST';
var FETCH_GIF_FAILURE = exports.FETCH_GIF_FAILURE = 'FETCH_GIF_FAILURE';
var FETCH_GIF_SUCCESS = exports.FETCH_GIF_SUCCESS = 'FETCH_GIF_SUCCESS';
